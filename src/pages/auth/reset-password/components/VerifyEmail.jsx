...
import { httpResetPassword } from "@/services/api/requests/auth.requests";
import {
  getValidationStatus,
...
const VerifyEmail = ({ forgotPasswordData, user_email, setStep }) => {
  ...
  const onSubmit = (values) => {
    const data = {
      username: get(forgotPasswordData, "username", ""),
          ...
          <Col span={24}>
            <Flex align="center" justify="center" vertical>
              ...
              <Text level={5} align="center">
                {i18n.language === "uz" ? (
                  <>
                    Tasdiqlash kodi <b>{user_email}</b> ga yuborildi. <br />
                  ...
                  <>
                    Код подтверждения отправлен на адрес <b>{user_email}</b>.{" "}
                    <br />
