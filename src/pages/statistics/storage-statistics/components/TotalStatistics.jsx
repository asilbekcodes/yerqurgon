...
import { httpGetStorageStatisticsTotal } from "@/services/api/requests/statistics.request";
...
const TotalStatitics = () => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: httpGetStorageStatisticsTotal,
                  ...
                  <Row gutter={[20, 20]}>
                    <Col xs={24} md={8}>
                      <CustomStatisticsCard
                        ...
                        value={get(data, "storage_count", 0)}
                        precision={2}
                    ...
                    <Col xs={24} md={8}>
                      <CustomStatisticsCard
                        ...
                        value={get(data, "storage_total_summa", 0)}
                        precision={2}
                    ...
                    <Col xs={24} md={8}>
                      <CustomStatisticsCard
                        ...
                        value={get(data, "storage_payments", 0)}
                        precision={2}
                        prefix={<RiCashFill />}
                        suffix={currency_type}
                      />
