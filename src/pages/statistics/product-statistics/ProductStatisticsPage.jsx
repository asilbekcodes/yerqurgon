...
import { useProductBreadcrumbItems } from "../breadcrumbs/useProductBreadcrumb";
...
const ProductStatisticsPage = () => {
  ...
  const BREADCRUMB_ITEMS = useProductBreadcrumbItems();

  return (
    <>
      <Helmet>
        <title>{t("Mahsulotlar statistikasi")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Mahsulotlar statistikasi")}</PageTitle>
            <Flex gap={"middle"}>
              <BackButton />
            </Flex>
          </Flex>
