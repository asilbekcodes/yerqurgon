...
import { prepareAddPaymentTradeDto } from "@/services/api/prepare-data/trade";
...
const AddPaymentForOrder = ({ summa, refetch, item }) => {
...
export default AddPaymentForOrder;
