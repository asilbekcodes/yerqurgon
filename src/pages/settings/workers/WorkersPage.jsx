...
import { httpGetWorkers } from "@/services/api/requests/workers.requests";
...
import { useWorkerColumns } from "./useWorkerColumns";
...
const WorkersPage = () => {
  ...
  const TABLE_COLUMNS = useWorkerColumns(
    pagination,
    filters,
    setFilters,
    refetch
  ...
  return (
    <>
      <Helmet>
        <title>{t("Xodimlar")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Xodimlar")}</PageTitle>
          </Flex>
        </Col>
        <Col span={24}>
