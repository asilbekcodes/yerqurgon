import ExampleFileUrl from "@/assets/file/Format_example.xlsx";
...
import { useProductFormatColumns } from "./useProductFormatColumns";

const ProductFormatsPage = () => {
  ...
  const TABLE_COLUMNS = useProductFormatColumns(
    pagination,
    filters,
    setFilters,
    refetch
  ...
  return (
    <>
      <Helmet>
        <title>{t("Mahsulot formatlari")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Mahsulot formatlari")}</PageTitle>
          </Flex>
        </Col>
        <Col span={24}>
          ...
          <Row gutter={[20, 20]}>
            ...
            <Col xs={24} sm={24} md={24} lg={18} xl={18}>
              <Flex align="center" justify="end" gap="middle">
                <UploadButton
                  uploadRequest={httpImportProductFormats}
                  refetch={refetch}
...
export default ProductFormatsPage;
