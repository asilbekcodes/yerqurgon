...
import { httpGetFinanceOutcomes } from "@/services/api/requests/finance-outcomes.requests";
...
import { useFinanceOutcomeColumns } from "./useFinanceOutcomeColumns";

const FinanceOutcomesPage = () => {
  ...
  const TABLE_COLUMNS = useFinanceOutcomeColumns(
    pagination,
    filters,
    setFilters,
    refetch
  ...
  return (
    <>
      <Helmet>
        <title>{t("Chiqimlar")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Chiqimlar")}</PageTitle>
          </Flex>
        </Col>
        <Col span={24}>
...
export default FinanceOutcomesPage;
