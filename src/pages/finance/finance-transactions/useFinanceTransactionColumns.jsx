...
import { httpDeleteFinanceTransaction } from "@/services/api/requests/finance-transactions.requests";
...
export const useFinanceTransactionColumns = (
  pagination,
  filters,
  setFilters,
  refetch
  ...
  const deleteMutate = useMutation({
    mutationFn: httpDeleteFinanceTransaction,
    onSuccess: () => {
