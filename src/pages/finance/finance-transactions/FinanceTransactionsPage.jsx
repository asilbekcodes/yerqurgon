...
import { httpGetFinanceTransactions } from "@/services/api/requests/finance-transactions.requests";
...
import {
  useFinanceTransactionColumns
} from "./useFinanceTransactionColumns";
...
const FinanceTransactionsPage = () => {
  ...
  const TABLE_COLUMNS = useFinanceTransactionColumns(
    pagination,
    filters,
    setFilters,
    refetch
  ...
  return (
    <>
      <Helmet>
        <title>{t("Moliya tranzaktsiyalari")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Moliya tranzaktsiyalari")}</PageTitle>
          </Flex>
        </Col>
        <Col span={24}>
