...
import { httpGetStorageProductsOff } from "@/services/api/requests/storage-products-off.requests";
...
import { useStorageProductOffColumns } from "./useStorageProductOffColumns";

const StorageProductsOffPage = () => {
  ...
  const TABLE_COLUMNS = useStorageProductOffColumns(
    pagination,
    filters,
    setFilters,
    refetch
  ...
  return (
    <>
      <Helmet>
        <title>{t("Yaroqsiz mahsulotlar")}</title>
      </Helmet>
      <Row gutter={[20, 20]}>
        <Col span={24}>
          <Flex align="center" justify="space-between">
            <PageTitle>{t("Yaroqsiz mahsulotlar")}</PageTitle>
          </Flex>
        </Col>
        <Col span={24}>
...
export default StorageProductsOffPage;
